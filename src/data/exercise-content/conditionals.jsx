    ...
    export const conditionalsExercises = {
      'conditionals-zero': {
        ...
        level3: [
          { id: 'cond0-l3-1', sentence: 'If metal ____ (get) very cold, it ____ (contract).', options: ['gets / contracts', 'get / contract', 'getting / contracting'], correct: 'gets / contracts' },
          { id: 'cond0-l3-2', sentence: 'When you ____ (not sleep) enough, your concentration ____ (suffer).', options: ['don\'t sleep / suffers', 'doesn\'t sleep / suffer', 'not sleeping / suffering'], correct: 'don\'t sleep / suffers' },
          { id: 'cond0-l3-3', sentence: 'If a computer ____ (overheat), it often ____ (shut down) automatically.', options: ['overheats / shuts down', 'overheat / shut down', 'overheating / shutting down'], correct: 'overheats / shuts down' },
          { id: 'cond0-l3-4', sentence: 'Does food ____ (spoil) faster if it ____ (not be) refrigerated?', options: ['spoil / isn\'t', 'spoils / aren\'t', 'spoiling / not being'], correct: 'spoil / isn\'t' },
          { id: 'cond0-l3-5', sentence: 'When you ____ (exercise) regularly, your body ____ (become) stronger.', options: ['exercise / becomes', 'exercises / become', 'exercising / becoming'], correct: 'exercise / becomes' },
          { id: 'cond0-l3-6', sentence: 'If you ____ (leave) milk out in the sun, it ____ (go) bad.', options: ['leave / goes', 'leaves / go', 'leaving / going'], correct: 'leave / goes' },
          { id: 'cond0-l3-7', sentence: 'What ____ (happen) if you ____ (mix) baking soda and vinegar?', options: ['happens / mix', 'happen / mixes', 'happening / mixing'], correct: 'happens / mix' },
          { id: 'cond0-l3-8', sentence: 'If a plant ____ (not receive) sunlight, it ____ (cannot) photosynthesize.', options: ['doesn\'t receive / cannot', 'don\'t receive / can\'t', 'not receiving / cannot'], correct: 'doesn\'t receive / cannot' },
          { id: 'cond0-l3-9', sentence: 'When you ____ (tell) a lie, your nose ____ (not grow) longer, despite the story.', options: ['tell / doesn\'t grow', 'tells / don\'t grow', 'telling / not growing'], correct: 'tell / doesn\'t grow' },
          { id: 'cond0-l3-10', sentence: 'If you ____ (add) salt to water, its boiling point ____ (increase) slightly.', options: ['add / increases', 'adds / increase', 'adding / increasing'], correct: 'add / increases' },
        ]
      },
      'conditionals-first': {
        level1: [
        ...
        level3: [
          { id: 'cond1-l3-1', sentence: 'Unless you ___ (apologize), she ___ (not forgive) you.', options: ['apologize / won\'t forgive', 'don\'t apologize / will forgive', 'apologize / doesn\'t forgive'], correct: 'apologize / won\'t forgive' },
          { id: 'cond1-l3-2', sentence: 'If the traffic ___ (be) bad, I ___ (be) late for the meeting.', options: ['is / will be', 'will be / am', 'is / am'], correct: 'is / will be' },
          { id: 'cond1-l3-3', sentence: 'He ___ (call) the police if the noise ___ (not stop).', options: ['will call / doesn\'t stop', 'calls / won\'t stop', 'will call / not stop'], correct: 'will call / doesn\'t stop' },
          { id: 'cond1-l3-4', sentence: 'Provided that you ___ (finish) your work, you ___ (can) go home early.', options: ['finish / can', 'will finish / can', 'finish / will can'], correct: 'finish / can' },
          { id: 'cond1-l3-5', sentence: 'What ___ we ___ (do) if the client ___ (not agree) to our terms?', options: ['will / do / doesn\'t agree', 'do / do / won\'t agree', 'will / do / not agree'], correct: 'will / do / doesn\'t agree' },
          { id: 'cond1-l3-6', sentence: 'If you ___ (not water) these plants regularly, they ___ (die) soon.', options: ['don\'t water / will die', 'won\'t water / die', 'doesn\'t water / will die'], correct: 'don\'t water / will die' },
          { id: 'cond1-l3-7', sentence: 'She ___ (get) a promotion if she ___ (perform) well in this project.', options: ['will get / performs', 'gets / will perform', 'will get / will perform'], correct: 'will get / performs' },
          { id: 'cond1-l3-8', sentence: 'As long as you ___ (keep) practicing, your English ___ (improve).', options: ['keep / will improve', 'will keep / improves', 'keep / improves'], correct: 'keep / will improve' },
          { id: 'cond1-l3-9', sentence: 'If the company ___ (not invest) in new technology, it ___ (fall) behind its competitors.', options: ['doesn\'t invest / will fall', 'won\'t invest / falls', 'not invest / will fall'], correct: 'doesn\'t invest / will fall' },
          { id: 'cond1-l3-10', sentence: 'We ___ (go) skiing next winter if we ___ (save) enough money.', options: ['will go / save', 'go / will save', 'will go / will save'], correct: 'will go / save' },
        ]
      },
      'conditionals-second': { 
        level1: [
        ...
        level3: [
          { id: 'cond2-l3-1', sentence: 'If I ___ (be) the president, I ___ (invest) more in education.', options: ['were / would invest', 'was / would invest', 'am / will invest'], correct: 'were / would invest' },
          { id: 'cond2-l3-2', sentence: 'She ___ (not be) so stressed if her boss ___ (give) her less work.', options: ['wouldn\'t be / gave', 'won\'t be / gives', 'wasn\'t / would give'], correct: 'wouldn\'t be / gave' },
          { id: 'cond2-l3-3', sentence: 'What ___ you ___ (choose) if you ___ (can) have any superpower?', options: ['would / choose / could', 'will / choose / can', 'did / choose / could'], correct: 'would / choose / could' },
          { id: 'cond2-l3-4', sentence: 'If they ___ (offer) me the job in another country, I ___ (think) seriously about it.', options: ['offered / would think', 'offer / will think', 'would offer / thought'], correct: 'offered / would think' },
          { id: 'cond2-l3-5', sentence: 'He ___ (feel) much better if he ___ (not smoke) so much.', options: ['would feel / didn\'t smoke', 'will feel / doesn\'t smoke', 'felt / wouldn\'t smoke'], correct: 'would feel / didn\'t smoke' },
          { id: 'cond2-l3-6', sentence: 'If we ___ (have) a garden, we ___ (grow) our own vegetables.', options: ['had / would grow', 'have / will grow', 'had / grew'], correct: 'had / would grow' },
          { id: 'cond2-l3-7', sentence: 'I ___ (travel) more if I ___ (not have) so many commitments.', options: ['would travel / didn\'t have', 'will travel / don\'t have', 'travelled / wouldn\'t have'], correct: 'would travel / didn\'t have' },
          { id: 'cond2-l3-8', sentence: 'If you ___ (find) a million dollars, what ___ you ___ (do) with it?', options: ['found / would / do', 'find / will / do', 'would find / did / do'], correct: 'found / would / do' },
          { id: 'cond2-l3-9', sentence: 'She ___ (be) able to afford a new car if she ___ (save) a little each month.', options: ['would be / saved', 'will be / saves', 'was / would save'], correct: 'would be / saved' },
          { id: 'cond2-l3-10', sentence: 'If I ___ (know) the answer, I ___ (tell) you, but I honestly don\'t.', options: ['knew / would tell', 'know / will tell', 'had known / would have told'], correct: 'knew / would tell' },
        ]
      },
      'conditionals-third': {
        level1: [
        ...
        level3: [
          { id: 'cond3-l3-1', sentence: 'If the company ___ (invest) more in research, they ___ (develop) the product sooner.', options: ['had invested / would have developed', 'invested / would develop', 'had invested / developed'], correct: 'had invested / would have developed' },
          { id: 'cond3-l3-2', sentence: 'She ___ (not miss) her flight if she ___ (not get) stuck in traffic.', options: ['wouldn\'t have missed / hadn\'t gotten', 'didn\'t miss / wouldn\'t get', 'hadn\'t missed / wouldn\'t have gotten'], correct: 'wouldn\'t have missed / hadn\'t gotten' },
          { id: 'cond3-l3-3', sentence: 'What ___ they ___ (say) if you ___ (tell) them the truth earlier?', options: ['would / have said / had told', 'would / say / told', 'did / say / would have told'], correct: 'would / have said / had told' },
          { id: 'cond3-l3-4', sentence: 'If he ___ (listen) to my advice, he ___ (not make) that mistake.', options: ['had listened / wouldn\'t have made', 'listened / wouldn\'t make', 'had listened / didn\'t make'], correct: 'had listened / wouldn\'t have made' },
          { id: 'cond3-l3-5', sentence: 'I ___ (finish) the marathon if I ___ (train) harder.', options: ['would have finished / had trained', 'would finish / trained', 'finished / would have trained'], correct: 'would have finished / had trained' },
          { id: 'cond3-l3-6', sentence: 'If we ___ (know) the restaurant was so popular, we ___ (book) a table in advance.', options: ['had known / would have booked', 'knew / would book', 'had known / booked'], correct: 'had known / would have booked' },
          { id: 'cond3-l3-7', sentence: 'The project ___ (be) a success if they ___ (manage) it better.', options: ['would have been / had managed', 'would be / managed', 'was / would have managed'], correct: 'would have been / had managed' },
          { id: 'cond3-l3-8', sentence: 'If you ___ (warn) me about the delay, I ___ (take) a different route.', options: ['had warned / would have taken', 'warned / would take', 'had warned / took'], correct: 'had warned / would have taken' },
          { id: 'cond3-l3-9', sentence: 'She ___ (not get) the job if she ___ (not perform) well in the interview.', options: ['wouldn\'t have gotten / hadn\'t performed', 'didn\'t get / wouldn\'t perform', 'hadn\'t gotten / wouldn\'t have performed'], correct: 'wouldn\'t have gotten / hadn\'t performed' },
          { id: 'cond3-l3-10', sentence: 'They ___ (win) the match if their star player ___ (not get) injured.', options: ['would have won / hadn\'t gotten', 'would win / didn\'t get', 'won / wouldn\'t have gotten'], correct: 'would have won / hadn\'t gotten' },
        ]
      },
      'conditionals-mixed': {
        level1: [
        ...
        level3: [
          { id: 'condm-l3-1', sentence: 'If I ___ (not be) so tired now, I ___ (go) to the gym yesterday evening.', options: ['weren\'t / would have gone', 'wasn\'t / would go', 'am not / went'], correct: 'weren\'t / would have gone' },
          { id: 'condm-l3-2', sentence: 'He ___ (be) able to buy the house now if he ___ (save) more money last year.', options: ['would be / had saved', 'will be / saved', 'is / would have saved'], correct: 'would be / had saved' },
          { id: 'condm-l3-3', sentence: 'If she ___ (speak) English fluently, she ___ (get) that job abroad last month.', options: ['spoke / would have gotten', 'speaks / would get', 'had spoken / would get'], correct: 'spoke / would have gotten' },
          { id: 'condm-l3-4', sentence: 'We ___ (not be) in this situation if we ___ (make) a different decision back then.', options: ['wouldn\'t be / had made', 'won\'t be / made', 'aren\'t / would have made'], correct: 'wouldn\'t be / had made' },
          { id: 'condm-l3-5', sentence: 'If I ___ (know) you were allergic to nuts, I ___ (not put) them in the cake.', options: ['knew / wouldn\'t have put', 'had known / wouldn\'t put', 'know / won\'t put'], correct: 'knew / wouldn\'t have put' },
          { id: 'condm-l3-6', sentence: 'They ___ (have) a better relationship now if they ___ (communicate) more openly in the past.', options: ['would have / had communicated', 'will have / communicated', 'have / would have communicated'], correct: 'would have / had communicated' },
          { id: 'condm-l3-7', sentence: 'If he ___ (not be) so stubborn, he ___ (accept) their help when it was offered.', options: ['weren\'t / would have accepted', 'isn\'t / would accept', 'hadn\'t been / would accept'], correct: 'weren\'t / would have accepted' },
          { id: 'condm-l3-8', sentence: 'I ___ (be) rich now if I ___ (invest) in that company years ago.', options: ['would be / had invested', 'will be / invested', 'am / would have invested'], correct: 'would be / had invested' },
          { id: 'condm-l3-9', sentence: 'If she ___ (take) my advice, she ___ (not be) in trouble now.', options: ['had taken / wouldn\'t be', 'took / won\'t be', 'would take / isn\'t'], correct: 'had taken / wouldn\'t be' },
          { id: 'condm-l3-10', sentence: 'If you ___ (not be) afraid of flying, we ___ (travel) to Asia last summer.', options: ['weren\'t / would have travelled', 'aren\'t / would travel', 'hadn\'t been / would travel'], correct: 'weren\'t / would have travelled' },
        ]
      },
    };
