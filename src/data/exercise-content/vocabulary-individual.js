    ...
    const paronymsData = {
      ...
      level3: [
        ...
        { id: 'par-l3-10', sentence: 'She tried to ____ asense of ____ among her team members.', options: ['instill / camaraderie', 'install / camaraderie', 'instill / comraderie'], correct: 'instill / camaraderie' },
      ],
    };
    export const paronymsExercises = processTopic(paronymsData);
    ...
    export const synonymsExercises = processTopic(synonymsData);
    ...
    export const antonymsExercises = processTopic(antonymsData);

    export const irregularVerbs1PastExercises = processTopic(generateIrregularVerbExercises(verbLists.past1, 'past simple', 'viv1p'));
    export const irregularVerbs2PastExercises = processTopic(generateIrregularVerbExercises(verbLists.past2, 'past simple', 'viv2p'));
    export const irregularVerbs3PastExercises = processTopic(generateIrregularVerbExercises(verbLists.past3, 'past simple', 'viv3p'));
    export const irregularVerbs4ParticipleExercises = processTopic(generateIrregularVerbExercises(verbLists.participle1, 'participle', 'viv4pp'));
    export const irregularVerbs5ParticipleExercises = processTopic(generateIrregularVerbExercises(verbLists.participle2, 'participle', 'viv5pp'));
    export const irregularVerbs6ParticipleExercises = processTopic(generateIrregularVerbExercises(verbLists.participle3, 'participle', 'viv6pp'));
    
    export const nouns1Exercises = processTopic(generateNewVocabularyExercises(newVocabularyData.nouns1, 'vnoun1'));
    export const nouns2Exercises = processTopic(generateNewVocabularyExercises(newVocabularyData.nouns2, 'vnoun2'));
    export const nouns3Exercises = processTopic(generateNewVocabularyExercises(newVocabularyData.nouns3, 'vnoun3'));
    export const adjectives1Exercises = processTopic(generateNewVocabularyExercises(newVocabularyData.adjectives1, 'vadj1'));
    export const adjectives2Exercises = processTopic(generateNewVocabularyExercises(newVocabularyData.adjectives2, 'vadj2'));
    export const adjectives3Exercises = processTopic(generateNewVocabularyExercises(newVocabularyData.adjectives3, 'vadj3'));
    export const verbs1Exercises = processTopic(generateNewVocabularyExercises(newVocabularyData.verbs1, 'vverb1'));
    export const verbs2Exercises = processTopic(generateNewVocabularyExercises(newVocabularyData.verbs2, 'vverb2'));
    export const verbs3Exercises = processTopic(generateNewVocabularyExercises(newVocabularyData.verbs3, 'vverb3'));
